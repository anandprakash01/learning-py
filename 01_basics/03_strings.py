...
print(
    "Apple" < "apple"
)  # True (uppercase letters have lower code points than lowercase)
...
print(
    alpha[2:99]
)  # '2345' substring from index 2 to end last (99 is out of range but it doesn't raise an error, it just goes to the end)
